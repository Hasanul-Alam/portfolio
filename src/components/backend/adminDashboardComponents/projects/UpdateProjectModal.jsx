...
const UpdateProjectModal = ({
  ...
  const [formData, setFormData] = React.useState({
    projectType: projectData ? projectData.projectType : "",
    image: projectData ? projectData.image : "",
    name: projectData ? projectData.name : "",
    description: projectData ? projectData.description : "",
    technologies: projectData ? projectData.technologies : "",
    duration: projectData ? projectData.duration : "",
    liveLink: projectData ? projectData.liveLink : "",
    codeLink: projectData ? projectData.codeLink : "",
    playStoreLink: projectData ? projectData.playStoreLink : "",
    appStoreLink: projectData ? projectData.appStoreLink : "",
  });
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.put(
        `https://portfolio-server-uuad.onrender.com/api/projects/${projectData._id}`,
        formData
      );
